        ...
        path.copy(node = preVisit(path)).run {
            node.run {
                @Suppress("UNCHECKED_CAST") val new: T = when (this) {
                    ...
                    is Node.Declaration.ClassBase.ConstructorClassParent -> copy(
                        type = visitChildren(type, newCh),
                        lPar = visitChildren(lPar, newCh),
                        args = visitChildren(args, newCh),
                        rPar = visitChildren(rPar, newCh),
                    )
                    is Node.Declaration.ClassBase.DelegationClassParent -> copy(
                        type = visitChildren(type, newCh),
                        expression = visitChildren(expression, newCh),
                    )
                    is Node.Declaration.ClassBase.TypeClassParent -> copy(
                        type = visitChildren(type, newCh),
                    )
                    ...
                    is Node.Declaration.ClassBase.ClassBody -> copy(
                        enumEntries = visitChildren(enumEntries, newCh),
                        declarations = visitChildren(declarations, newCh),
                    )
                    is Node.Declaration.ClassBase.ClassBody.Initializer -> copy(
                    ...
                    is Node.Declaration.ClassBase.ClassBody.SecondaryConstructor -> copy(
                        modifiers = visitChildren(modifiers, newCh),
                        constructorKeyword = visitChildren(constructorKeyword, newCh),
                        lPar = visitChildren(lPar, newCh),
                        params = visitChildren(params, newCh),
                    ...
                    is Node.Declaration.ClassBase.ClassBody.EnumEntry -> copy(
                        modifiers = visitChildren(modifiers, newCh),
                        name = visitChildren(name, newCh),
                        lPar = visitChildren(lPar, newCh),
                        args = visitChildren(args, newCh),
